...
#define AT_UART_BAUD_RATE_MIN                       115200                  /**< minimum uart baud rate */
...
#define AT_UART_QUEUE_SIZE                          10240                   /**< uart queue size */
#endif
...
#define CONFIG_AT_UART_PORT_TX_PIN_DEFAULT          4
#define CONFIG_AT_UART_PORT_RX_PIN_DEFAULT          5
#define CONFIG_AT_UART_PORT_CTS_PIN_DEFAULT         6
#define CONFIG_AT_UART_PORT_RTS_PIN_DEFAULT         7
#endif
